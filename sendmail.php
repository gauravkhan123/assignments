...
if(isset($_POST['name']) && isset($_POST['email']))
 {
    ...
    //echo "insert into leads (name, email, phone, source, message, date) values('".$name."', '".$email."', '".$phone."', '".$source."')";
    //mysql_query("insert into leads (name, email, phone, source, course, message, date) values('".$name."', '".$email."', '".$phone."', '".$source."','".$courses."','".$message."','".$date."')");
    ...
    $date = date("m-d-Y");
        ////////////////////////////////////////////email///////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    $mail = new PHPMailer();
                    $mail->IsSMTP();
                    $mail->Host = "mail.digitaledgeinstitute.com";
                    $mail->SMTPAuth = true;
                    $mail->Username = "leads@digitaledgeinstitute.com";
                    $mail->Password = "Leads@#11";
                    $mail->From = "leads@digitaledgeinstitute.com";
                    $mail->FromName = "PC Help Number";
                    $mail->AddReplyTo("leads@digitaledgeinstitute.com", "PC Help Number");
                    $mail->Port = "587";
                    $mail->IsHTML(true);
                    $mail->Subject = 'New lead Posted on PC Help Number';
                    $mail->Body = "
                                                           ...
                                                           <tbody>
                                                              ...
                                                              <tr>
                                                                 <td width='350' class='devicewidth'>
                                                                    <a href='#'><img src='https://www.digitaledgeinstitute.com/images/delhi.png' alt='PC Help Number' border='0' style='width:245;height:65;'></a>                                                                    
                                                                 </td>
                                                              </tr>
                                                              <!-- /image -->
                                                           </tbody>
                             ...
                             <td>
                                <table width='600' cellpadding='0' cellspacing='0' border='0' align='center' class='devicewidth'>
                                   <tbody>
                                      <tr>
                                         <td width='100%'>
                                            <table width='580' bgcolor='#002147' cellpadding='0' cellspacing='0' border='0' align='center' class='devicewidth'>
                                               <tbody>
                                                  <tr>
                                                     <td>
                                                        <!-- start of menu -->
                                                        <table bgcolor='#002147' width='580' height='16' border='0' align='right' valign='middle' cellpadding='7' cellspacing='0' border='0' class='devicewidth'>
                                                           <tbody>
                                                              <tr>
                                                                 <td height='16' align='left' valign='middle' style='font-family: Helvetica, arial, sans-serif; font-size: 13px;color: #002147' st-content='menu'>
                                                                    <a href='#' style='color: #fff;text-decoration: none; font-weight:bold;'>Email Supports &nbsp; &nbsp;</a>                                                
                                                                 </td>
                                                                 <td height='16' align='right' valign='middle' style='font-family: Helvetica, arial, sans-serif; font-size: 13px;color: #002147' st-content='menu'>
                                                                    ...
                                                                    <table width='580' align='center' border='0' cellpadding='0' cellspacing='0' class='devicewidth'>
                                                                       <tbody>
                                                                          ...
                                                                          <tr>
                                                                             ...
                                                                             <table>
                                                                                <tr height='25'>                                                                
                                                                                    <td align='left' valign='middle' height='25' style='color: #226203; font-family: corbel; font-size:17px; font-weight:bold;'>Email Support</td>
                                                                                </tr>
                                                                                <tr height='100'>                                                                
 ...
 <tr>
                             ...
                             <td>
                                <table width='600' bgcolor='#eacb3c' cellpadding='0' cellspacing='0' border='0' align='center' class='devicewidth'>
                                   <tbody>
                                      <tr>
                                         <td width='100%'>
                                            <table bgcolor='#002147' width='600' cellpadding='0' cellspacing='0' border='0' align='center' class='devicewidth'>
                                               <tbody>
                                                  <!-- Spacing -->
                                                  <tr>
                    ...
                    <!-- End of footer -->
                       ...
                       ";
                   //$mail->AddAddress("satish@hikesoftwares.com");
                   $mail->AddAddress("khandelwalgauravkhandelwal@gmail.com");
                    $mail->Send();
